...
import ContactFormSection from "../components/core/AboutPage/ContactFoemSection";
import Footer from "../components/common/Footer";
import RatingSlider from "../components/common/ReviewSlider";
...
const About = () => {
  return (
    <div>
      <Helmet>
        <title>StudyNotion - About Us</title>
        <meta
          name="description"
      ...
      <section className="bg-richblack-700 mt-14">
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          ...
          <div className="absolute bottom-0 left-[50%] grid place-items-center w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
            <img
              data-aos="fade-right"
              data-aos-duration="1500"
              src={BannerImage1}
